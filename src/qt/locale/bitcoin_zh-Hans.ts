...
<context>
    ...
    <message>
        <source>These are your addresses for receiving payments. Use the 'Create new receiving address' button in the receive tab to create new addresses.
...
<context>
    ...
    <message>
        <source>Error: Dumpfile version is not supported. This version of l15node-wallet only supports version 1 dumpfiles. Got dumpfile with version %s</source>
        <translation type="unfinished">错误: 转储文件版本不被支持。这个版本的 l15node-wallet 只支持版本为 1 的转储文件。得到的转储文件版本却是%s</translation>
    </message>
    <message>
    ...
    <message>
        <source>%s request to listen on port %u. This port is considered "bad" and thus it is unlikely that any L15 Core peers connect to it. See doc/p2p-bad-ports.md for details and a full list.</source>
        <translation type="unfinished">%s请求监听端口 %u。这个端口被认为是“坏的”，所以不太可能有L15 Core节点会连接到它。有关详细信息和完整列表，请参见 doc/p2p-bad-ports.md 。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        <source>Send coins to an address</source>
    ...
    <message>
        ...
        <translation type="unfinished">请求支付 (生成二维码和 L15n: URI)</translation>
    </message>
    <message>
    ...
    <message>
        <source>Load Partially Signed Transaction</source>
    ...
    <message>
        <source>Load Partially Signed Transaction from clipboard</source>
