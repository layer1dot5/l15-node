...
const char * const BITCOIN_CONF_FILENAME = "l15.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "L15";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/L15";
#else
    // Unix-like
    return pathRet / ".l15";
#endif
